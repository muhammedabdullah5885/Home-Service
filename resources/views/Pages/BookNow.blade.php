        ...
        <div class="wrapper">
            <div class="forms-16-top">
                <div class="forms-16-info">
                    <h5>Let us serve you!</h5>
                    <h3>Service Maintenance at your house</h3>
                ...
                <div class="form-right-inf logo">
                    <div class="form-inner-cont" style="position: relative; background-image: url('assets/images/carpenter.jpg'); background-size: cover; background-position: center;">
                            ...
                            <form action="#" method="post" class="signin-form">
                                ...
                                <div class="form-input">
                                    <select name="service" id="service">
                                        ...
                                        <option value="WaterTankCleaning">Water Tank Cleaning</option>
                                        <option value="OfficeFitOut">Office Fit Out</option>
                                ...
                                <p><b>This Assistance will be related to above selected work</b></p>
                            </form>
                        </div>
                    </div>
