        ...
        <div class="wrapper">
            <div class="forms-16-top">
                <div class="forms-16-info">
                    <h5>Officefitout Service</h5>
                    <h3>Officefitout Services Maintenance at your house</h3>
                ...
                <div class="form-right-inf logo">
                    <div class="form-inner-cont" style="position: relative; background-image: url('assets/images/building.jpg'); background-size: cover; background-position: center;">
                        ...
                        <form action="#" method="post" class="signin-form">
                            ...
                            <p><b>This Assistance will be related to Officefitout work</b></p>
                        </form>
                        </div>
                    </div>
